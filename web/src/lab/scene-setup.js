...
export function mountSceneSetup({onApply, onClose = () => {}, requiresRestart = () => true}) {
  ...
  function renderAdvancedDuck(d) {
    return `<details class="setup-details" data-setup-panel="advanced-brain"><summary>Advanced vision & brain settings</summary><div class="setup-details-content"><p class="setup-help">Preset research settings are preserved. Open these when you want a controlled comparison.</p>
