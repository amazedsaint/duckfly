export const SCENARIOS = [
  ...
  {id: "stop-go", title: "Stop, wait, go", tag: "New · research", description: "Should a duck restart on a timer, or wait for danger to clear? Try both and test false alarms.", action: "Test the feedback loop", guide: "Choose an object path and stop response. Each choice runs the same 5-second trial.", alt: "Duck watching an approaching object in the stop-loop experiment"},
  ...
  {id: "recovery", title: "Bump and recover", tag: "New · body feedback", description: "Nudge the walking duck. Does sending body feedback to the fly circuit change what follows?", action: "Test its balance", guide: "Nudge the duck, then compare an identical reset with feedback switched off.", alt: "Microduck walking across an open balance-testing arena"},
  {
    id: "occlusion",
    title: "Out of sight",
