...
export function launchPageMarkup() {
  return `<section id="launch-page" class="launch-page launch-is-still" data-motion="paused" aria-labelledby="launch-title" tabindex="-1" hidden>
    ...
    <section class="launch-connection" aria-labelledby="launch-connection-title">
      <div class="launch-connection-copy"><p class="launch-kicker">SEE WHAT DRIVES EACH ACTION</p><h2 id="launch-connection-title">Change a connection.<br>Watch the response.</h2><p>Follow a scent with the eyes covered, or pause when the duck touches an object. The editor shows each signal’s value and whether its action is active or blocked.</p><p class="launch-source-note">Signals come from the simulated 668-neuron fly circuit and the duck’s sensors. Scent is a modeled field; touch comes from physical contact. Each source is labeled in the editor.</p></div>
